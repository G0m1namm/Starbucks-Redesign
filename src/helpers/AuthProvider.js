...
export default function AuthProvider() {
    ...
    const {state: {user, isError}, handleSignout, handleSignIn, handleSignUp, handleConfirmSignUp, handleResendSignUp} = useAmplifyAuth(history);
                ...
                <Switch>
                    ...
                    <FormDataContext.Provider>
                        ...
                        <PrivateRouter path="/register" user={user}>
                            <Register handleSignUp={handleSignUp} setEmail={(email) => setEmail(email)}/>
                        </PrivateRouter>
                        {isError ? (<Redirect to="/home"/>) :
                            (<PrivateRouter path="/verify">
